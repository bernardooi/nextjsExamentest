      ...
      <div className="NTI-background">
        ...
        <div className="about-cont">
            ...
            <h4 className="about-text">
                ...
                <br /><br />
                Examensgrad Räknare vill ge lärare en bekväm och effektiv plattform som de kan använda för att registrera och beräkna examensgrad baserat på inlämnad studentdata. Webbplatsen kommer att erbjuda ett användarvänligt gränssnitt där lärare laddar upp CSV-filer med betygen från deras elever.
                <br /><br />
